...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Jdcoin features */
        {"jdcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"jdcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"jdcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"jdcoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"jdcoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"jdcoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"jdcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"jdcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"jdcoin", "startmasternode", &startmasternode, true, true, false},
        {"jdcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"jdcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"jdcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"jdcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"jdcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"jdcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"jdcoin", "preparebudget", &preparebudget, true, true, false},
        {"jdcoin", "submitbudget", &submitbudget, true, true, false},
        {"jdcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"jdcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"jdcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"jdcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"jdcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"jdcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"jdcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"jdcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"jdcoin", "mnsync", &mnsync, true, true, false},
        {"jdcoin", "spork", &spork, true, true, false},
        {"jdcoin", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> jdcoin-cli " + methodname + " " + args + "\n";
}
