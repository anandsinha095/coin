...
#include "qt/jdcoin/forms/ui_coldstakingwidget.h"
#include "qt/jdcoin/qtutils.h"
#include "amount.h"
#include "guiutil.h"
#include "qt/jdcoin/requestdialog.h"
#include "qt/jdcoin/tooltipmenu.h"
...
ColdStakingWidget::ColdStakingWidget(JdcoinGUI* parent) :
    PWidget(parent),
    ...
    isLoading(false)
{
    ...
    /* Subtitle */
    ui->labelSubtitle1->setText(tr("You can delegate your JDCs, letting a hot node (24/7 online node)\nstake on your behalf, while you keep the keys securely offline."));
    ...
    ui->labelSubtitle2->setText(tr("Accept JDC delegation / Delegate JDC"));
    ...
    ui->btnCoinControl->setSubTitleClassAndText("text-subtitle", "Select JDC outputs to delegate.");
...
void ColdStakingWidget::updateStakingTotalLabel()
{
    ...
    ui->labelStakingTotal->setText(tr("Total Staking: %1").arg(
            (total == 0) ? "0.00 JDC" : GUIUtil::formatBalance(total, nDisplayUnit))
    );
}
