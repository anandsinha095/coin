...
#include "config/jdcoin-config.h" /* for USE_QTCHARTS */
#endif
...
public:
    ...
    qint64 totalJDC = 0;
    qint64 totalsJDC = 0;
    QList<qreal> valuesJDC;
    QList<qreal> valuessJDC;
    QStringList xLabels;
};
...
public:
    explicit DashboardWidget(JdcoinGUI* _window);
    ~DashboardWidget();
