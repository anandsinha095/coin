...
#include "qt/jdcoin/coincontrolkkcwidget.h"
#include "qt/jdcoin/forms/ui_coincontrolkkcwidget.h"

CoinControlJDCWidget::CoinControlJDCWidget(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::CoinControlJDCWidget)
{
    ui->setupUi(this);
    ...
    ui->labelTitle->setText("Select JDC Outputs to Spend");
    ...
    ui->labelTitleAmount->setText("JDC");
    ...
    ui->labelValueAfter->setText("0.00 JDC");
    ui->labelValueAmount->setText("0");
    ui->labelValueBytes->setText("0");
    ui->labelValueDust->setText("No");
    ui->labelValueChange->setText("0.00 JDC");
    ui->labelValueFee->setText("0.00 JDC");
...
CoinControlJDCWidget::~CoinControlJDCWidget()
{
    delete ui;
}
