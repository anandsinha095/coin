...
#include "qt/jdcoin/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(JdcoinGUI* _window, QWidget *parent) :
