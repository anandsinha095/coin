...
#include "qt/jdcoin/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/jdcoin/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(JdcoinGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::clear(){
    ...
    message(CMD_REPLY, (tr("Welcome to the Jdcoin RPC console.") + "<br>" +
