...
#include "qt/jdcoin/settings/settingsnetworkwidget.h"
#include "qt/jdcoin/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/jdcoin/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(JdcoinGUI* _window, QWidget *parent) :
