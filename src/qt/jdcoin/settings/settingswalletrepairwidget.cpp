...
#include "qt/jdcoin/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/jdcoin/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(JdcoinGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to JdcoinGUI::handleRestart()
