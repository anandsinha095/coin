...
#include "qt/jdcoin/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/jdcoin/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(JdcoinGUI* _window, QWidget *parent) :
