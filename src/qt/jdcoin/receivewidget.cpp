...
#include "qt/jdcoin/forms/ui_receivewidget.h"
...
#include "qt/jdcoin/addressholder.h"
...
ReceiveWidget::ReceiveWidget(JdcoinGUI* parent) :
    PWidget(parent),
    ui(new Ui::ReceiveWidget)
{
    ...
    ui->labelSubtitle1->setText(tr("Scan the QR code or copy the address to receive JDC."));
