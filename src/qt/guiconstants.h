...
/* Jdcoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Jdcoin"
#define QAPP_ORG_DOMAIN "jdcoin.org"
#define QAPP_APP_NAME_DEFAULT "Jdcoin-Qt"
#define QAPP_APP_NAME_TESTNET "Jdcoin-Qt-testnet"
