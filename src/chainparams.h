 ...
 * Jdcoin system. There are three: the main network on which people trade goods
...
public:
    ...
    int JdcoinBadBlockTime() const { return nJdcoinBadBlockTime; }
    int JdcoinBadBlocknBits() const { return nJdcoinBadBlocknBits; }
...
protected:
    ...
    int nLastPOWBlock;
    int64_t nJdcoinBadBlockTime;
    unsigned int nJdcoinBadBlocknBits;
