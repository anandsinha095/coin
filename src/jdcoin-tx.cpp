...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Jdcoin Core jdcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  jdcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded jdcoin transaction") + "\n" +
                               "  jdcoin-tx [options] -create [commands]   " + _("Create hex-encoded jdcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded jdcoin transaction
