...
#ifndef Jdcoin_sJDCTRACKER_H
#define Jdcoin_sJDCTRACKER_H
...
public:
    CsJDCTracker(std::string strWalletFile);
    ~CsJDCTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CsJDCWallet* sJDCWallet = NULL);
