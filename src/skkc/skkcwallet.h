...
#ifndef Jdcoin_sJDCWALLET_H
#define Jdcoin_sJDCWALLET_H
...
public:
    CsJDCWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicsJDC(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedTosJDC(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
