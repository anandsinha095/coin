...
CLegacysJDCStake::CLegacysJDCStake(const libzerocoin::CoinSpend& spend)
{
...
CBlockIndex* CLegacysJDCStake::GetIndexFrom()
{
...
CAmount CLegacysJDCStake::GetValue() const
{
    return denom * COIN;
}

CDataStream CLegacysJDCStake::GetUniqueness() const
{
