...
class RawTransactionsTest(JdcoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid jdcoin address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid jdcoin address" in e.error['message'])
