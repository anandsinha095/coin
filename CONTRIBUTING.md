Contributing to jdcoin Core
============================

The jdcoin Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/jdcoin-project/jdcoin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the jdcoin Core project, and is not to be
confused with overall jdcoin Network Protocol consensus changes.

Whether a pull request is merged into jdcoin Core rests with the project merge
...
Patches that change jdcoin consensus rules are considerably more involved than
...
Where a patchset proposes to change the jdcoin consensus, it must have been
...
The project leader is the release manager for each jdcoin Core release.
